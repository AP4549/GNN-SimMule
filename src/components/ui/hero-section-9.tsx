...
const menuItems = [
    { name: 'Research', href: '#' },
    { name: 'GNN Models', href: '#' },
    { name: 'Case Studies', href: '#' },
    { name: 'Banking Protocol', href: '#' },
]
        ...
        <div>
                                    ...
                                    <ul className="space-y-6 text-base lg:flex lg:gap-8 lg:space-y-0 lg:text-sm">
                                        {menuItems.map((item, index) => (
                                            <li key={index}>
                                                <Link
                                                    href={item.href}
                                                    className="text-muted-foreground hover:text-accent-foreground block duration-150 font-bold uppercase tracking-widest text-[10px]">
                                                    <span>{item.name}</span>
                                                </Link>
                                            </li>
                                        ))}
            ...
            <main>
                ...
                <section className="overflow-hidden bg-white dark:bg-transparent">
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
                        <div className="relative z-10 mx-auto max-w-2xl text-center">
                            <h1 className="text-balance text-4xl font-light md:text-5xl lg:text-7xl tracking-tighter italic font-serif">
                                High-Fidelity <span className="text-primary font-bold not-italic font-sans uppercase">Risk Propagation</span>
                            </h1>
                            <p className="mx-auto my-8 max-w-2xl text-lg text-muted-foreground leading-relaxed">
                                This research platform demonstrates non-linear fraud detection through recursive message-passing layers. Identified sub-threshold circularities that evade traditional rule-based systems.
                            </p>

                            <Button
                                asChild
                                size="lg"
                                className="rounded-xl px-12 py-6 shadow-xl shadow-primary/20">
                                <Link href="#">
                                    <span className="btn-label text-xs font-black uppercase tracking-[0.2em]">Initialize Model</span>
                                </Link>
                            </Button>
                        </div>
                    </div>
                        ...
                        <div className="[perspective:1200px] [mask-image:linear-gradient(to_right,black_50%,transparent_100%)] -mr-16 pl-16 lg:-mr-56 lg:pl-56">
                            <div className="[transform:rotateX(20deg);]">
                                <div className="lg:h-[44rem] relative skew-x-[.36rad]">
                                    ...
                                    />
                                    <img
                                        className="rounded-[--radius] z-[2] relative hidden border dark:block shadow-2xl opacity-80"
                                        src="https://images.unsplash.com/photo-1551288049-bbda4833effb?q=80&w=2070&auto=format&fit=crop"
                                        alt="Network analysis visualization"
                                        width={2880}
                                        height={2074}
                ...
                <section className="bg-background relative z-10 py-16">
                    <div className="m-auto max-w-5xl px-6">
                        <h2 className="text-center text-[10px] font-black uppercase tracking-[0.4em] text-muted-foreground">Institutional Research Partners</h2>
                        <div className="mx-auto mt-20 flex max-w-4xl flex-wrap items-center justify-center gap-x-12 gap-y-8 sm:gap-x-16 sm:gap-y-12 opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
    ...
    return (
        <div className={cn('flex items-center gap-3', className)}>
            <div className="flex -space-x-1.5">
                ...
                <div className="w-3 h-3 rounded-full border border-primary bg-primary/40 animate-pulse" />
                <div className="w-3 h-3 rounded-full border border-primary bg-primary" />
            </div>
            <span className="text-sm font-bold tracking-[0.2em] uppercase">GNN <span className="font-light italic pr-1">Sim</span>Mule</span>
        </div>
    )
}
